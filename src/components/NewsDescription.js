        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    ...
                    <h1 class="main-headline">Dubai's Water Bet: Desalination Meets Clean Energy</h1>
                    <p class="subtitle">A new plant uses cleaner technology and private capital to reshape water production in the Gulf</p>
                    
                    <div class="article-meta">
                        <div class="date">19 Mar 2025</div>
                        <div class="action-buttons">
                            <button class="btn-subscribe__NewsDescription">SUBSCRIBE</button>
            ...
            <div class="row">
                ...
                <div class="col-lg-8 col-md-7">
                    <div class="pe-lg-4">
                        ...
                        <img src={Newsimg} alt="Hassyan Desalination Plant Rendering" class="article-image"/>
                        </div>
                        <p class="article-text">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="card news-card_NewsDescription">
                        ...
                        <div class="card-content">
                            ...
                            <h3 class="card-title">Shale wastewater finds new purpose in Permian trial</h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="card news-card_NewsDescription">
                        ...
                        <div class="card-content">
                            ...
                            <h3 class="card-title">Dubai's Water Bet: Desalination Meets Clean Energy</h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="card news-card_NewsDescription">
                        ...
                        <div class="card-content">
                            ...
                            <h3 class="card-title">Gulf nations turn to seawater for future security</h3>
                        </div>
                    </div>
                </div>
            </div>
