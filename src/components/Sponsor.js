            ...
            <article className="SponsorsScreen_container__a4ngc">
              ...
              {/* <div className="SponsorCards_container__o3uWn">
                <div className="SponsorCards_AttendeesContainer__PLZ7L">
                  <h2>our sponsors</h2>
                  <div>
                    <img src={ArrowLeft} alt="arrow icon" width="16" loading="lazy" style={{display: "none"}}></img>
                    ...
                    <img src={ArrowRight} alt="arrow icon" width="16" loading="lazy"  style={{display: "none"}}></img>
                  </div>
                </div>
              </div> */}
              <div>
