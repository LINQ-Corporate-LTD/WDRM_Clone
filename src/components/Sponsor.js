...
import ArrowLeft from "../../src/assets/images/icon-arrow-left.png";
import ArrowRight from "../../src/assets/images/icon-arrow-right.png";
...
const Sponsors = () => {
  ...
  //     if (width <= 640) {
  //       setChunkSize(2);               // 2 logos
  //       setGridClass("grid-cols-2");   // 1 row
  //       setAutoplay(true);
  //     } else if (width <= 1230) {
  //       setChunkSize(4);               // 2x2
  //       setGridClass("grid-cols-2");   // 2 rows
  //       setAutoplay(true);
  //     } else {
  //       setChunkSize(6);               // 3x2
  ...
  // const getGridCols = () => {
  //   if (chunkSize === 2) return "grid-cols-2"; // mobile
  //   if (chunkSize === 4) return "grid-cols-2"; // tablet
  ...
  const cards = [
    {
      ...
      desc:
        "Maximize your visibility at our state-of-the-art exhibition facilities. Engage with top-tier industry leaders and key decision-makers.",
      points: [
    ...
    },
    {
      ...
      desc:
        "Gain access to meaningful engagement at the event. Our event is a hub for high-level networking and lead generation, attracting decision makers and industry influencers.",
      points: [
    ...
    },
    {
      ...
      desc:
        "Showcase your products and solutions at the upcoming event. Our event sets the stage for you to impress the industry's most influential leaders and media. Enjoy benefits like:",
      points: [
        ...
        <div style={{ opacity: 1 }}>
          <div style={{ marginTop: "90px" }}>
            <article className="SponsorsScreen_container__a4ngc">
              <div className="DetailsContainer_wholeContainer__385Iv" style={{ backgroundColor: "#e5e5e5" }}>
                <div className="DetailsContainer_container__JrWjX">
                  <div className="DetailsContainer_imageContainer__ncJwH" style={{ backgroundImage: `url(https://www.desalination-resource-recovery.com/images/sponsor-image.png)`, backgroundSize: "cover" }}>
                  </div>
                  <div className="DetailsContainer_textContainer__D8Ukb">
                    <h1>
                      Exhibit your services at Desalination & Resource Recovery 2025
                    </h1>
                    <div className="DetailsContainer_innerContent__6NQGR">
                      <div>
                        <p>
                          The Desalination & Resource Recovery 2025 event will be one of the largest exhibitions. A diverse range of utilities and desalination facilities will connect with leading technology providers and water treatment manufacturers to explore innovative solutions for sustainable desalination and resource optimisation.
                        </p>
                        <p>
                          We offer customised sponsorship and exhibitor packages, providing a cost-effective way to reach both existing and new target clients.
                        </p>
                      </div>
                    </div>
                    <button class="exhibit-btn_sponsor mt-5"
                      onClick={() => navigate("/sponsor-packages")}>exhibit now</button>
                  </div>
                </div>
              </div>
                          ...
                          {chunkedSponsors.map((group) => (
                            <div key={group.id}>
                              <div
                                ...
                                style={{
                                  display: "grid",
                                  gridTemplateColumns: `repeat(${group.gridColumns}, 1fr)`,
                              ...
                              >
                                {group.items.map((logo, i) => (
                                  <div key={i} className="SponsorCards_card__8eNkT">
                                    <img src={logo} alt={`Sponsor ${i + 1}`} loading="lazy" />
                                  </div>
                                ))}
                              </div>
                            </div>
                ...
                {isMobileScreen ? (
                  <Slider {...sliderSettings}>
                    {cards.map((card, index) => (
                      <div key={index}>
                        <div className="SponsorsScreen_exhibitCard__nXsu2">
                          <span>
                            <h4>{card.title}</h4>
                            <p>{card.desc}</p>
                            <ul>
                  ...
                  <div>
                    {cards.map((card, index) => (
                      <div key={index} className="SponsorsScreen_exhibitCard__nXsu2">
                        <span>
                          <h4>{card.title}</h4>
                          <p>{card.desc}</p>
                          <ul>
