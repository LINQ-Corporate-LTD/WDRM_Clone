            ...
            <div class="pt-[90px] pb-[30px]">
                <div className="speaker-profile-container">
                    <div className="profile-image-section" >
                        <img src='https://www.desalination-resource-recovery.com/api/images/1748008658078.png' alt="Right image" />
                    </div>

                    <div className="profile-content">
                        <div className="profile-header">
                            <h2 className="profile-title">Speaker's profile</h2>
                            <h1 className="speaker-name">AHMED YOUSRY</h1>
                            <p className="speaker-title">ACWA Power</p>
                        </div>

                        <div className="biography-section">
                            <h3 className="biography-section-title">BIOGRAPHY</h3>
                            <p className="biography-text">
                                Ahmed Yousry is a water and energy professional with over five
                                years of experience in desalination technologies, renewable energy
                                integration, and process optimization. He has contributed to
                                large-scale water projects by advancing sustainable designs and
                                improving operational efficiency.
                            </p>
                            <p className="biography-text">
                                Ahmed brings expertise in optimizing energy consumption,
                                statistical analysis, and simulation modelling, supporting the
                                development of efficient, clean energy solutions in the
                                desalination sector. His work focuses on driving innovation and
                                sustainability across water and energy systems.
                            </p>
                        </div>
