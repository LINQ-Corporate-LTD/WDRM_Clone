...
const WhoShouldAttend = () => {
  ...
  return (
    <>
      ...
      <div>
        <div style={{ paddingTop: "200px", paddingBottom: "100px", backgroundColor:"rgb(241, 241, 241)" }}>
        ...
        <div className="water-event-container">
          <div className="content-wrapper">
            ...
            <p className="description">
              ...
              key stakeholders assessing the economic feasibility of water
              network development. It also serves as a platform to explore the
              latest technologies that enhance operational efficiency.
            </p>
                ...
                {activeTab === "industries" && (
                  <div className="industries-content">
                    <h3 className="content-title">
                      ...
                      sectors working in water management, treatment, and
