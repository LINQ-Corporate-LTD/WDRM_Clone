                ...
                <div class="row">
                    ...
                    <div class="col-lg-7">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="section-content_BookingForm">
                                <div class="addon-item_BookingForm">
                                    <input type="checkbox" class="addon-checkbox_BookingForm" id="logo"/>
                                    <label for="logo" class="addon-text_BookingForm mb-0">Add your logo to the website</label> 
                                    <span class="addon-price_BookingForm">AED 400</span>
                                </div>
                                <div class="addon-item_BookingForm">
                                    <input type="checkbox" class="addon-checkbox_BookingForm" id="logo"/>
                                    <label for="logo" class="addon-text_BookingForm mb-0">Business cards placement</label> 
                        ...
                        <div class="mb-4">
                            ...
                            <div class="section-content_BookingForm">
                                <p class="mb-3">We accept all major credit and debit cards.</p>
                                ...
                                <div class="row mt-4">
                                    <div class="col-md-7">
                                        <input type="text" class="form-control card-input" placeholder="1234 1234 1234 1234"/>
                                    </div>
                                    <div class="col-md-3">
                                        <input type="text" class="form-control card-input" placeholder="MM / YY"/>
                                    </div>
                                    <div class="col-md-2">
                                        <input type="text" class="form-control card-input" placeholder="CVC"/>
                                    </div>
                                </div>
                                ...
                                <p class="security-text_BookingForm text-center">
                                    This is a secure AES-256 bit SSL Encrypted payment. You're safe.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-5">
                        <div class="mb-4">
                            ...
                            <div class="section-content_BookingForm">
                                ...
                                <input type="text" class="form-control discount-input_BookingForm total" placeholder="Discount Code"/>
